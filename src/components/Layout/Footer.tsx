        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div className="col-span-1 md:col-span-2">
            ...
            <p className="text-gray-300 mb-4 max-w-md">
              Transform your meal planning with AI-powered nutrition optimization, 
              smart grocery lists, and budget-friendly recipes tailored to your preferences.
            </p>
            <div className="flex items-center space-x-2 text-sm text-gray-400">
              <Heart size={16} className="text-red-400" />
              <span>Made with love for healthy living</span>
            </div>
          </div>
          ...
          <div>
            ...
            <div className="mt-6 space-y-2">
              <div className="flex items-center space-x-2 text-sm text-gray-400">
                <Mail size={16} />
                <span>support@mealplanner.com</span>
              </div>
              <div className="flex items-center space-x-2 text-sm text-gray-400">
                <Phone size={16} />
                <span>1-800-MEAL-PLAN</span>
              </div>
            </div>
          </div>
        </div>
        ...
        <div className="border-t border-gray-800 mt-8 pt-8">
          <div className="flex flex-col md:flex-row justify-between items-center">
            <p className="text-gray-400 text-sm">
              © {currentYear} MealPlanner. All rights reserved.
            </p>
